                    ...
                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                      ...
                      <li className="menu-item-has-children">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li><Link onClick={ClickHandler} href="/room-single/Deluxe-Queen-Room-102">Room single</Link></li>
                        </ul>
                      </li>
                      <li className="menu-item-has-children">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li><Link onClick={ClickHandler} href="/destination-single/Hiriketiya-Surf-Bay">Destinition single</Link></li>
                        </ul>
                      </li>
                      <li className="menu-item-has-children">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li className="menu-item-has-children">
                            ...
                            <ul className="sub-menu">
                              <li><Link onClick={ClickHandler} href="/blog-single/Top-5-Things-Hiriketiya-Beach">Blog details right sidebar</Link>
                              </li>
                              <li><Link onClick={ClickHandler} href="/blog-single-left-sidebar/Top-5-Things-Hiriketiya-Beach">Blog details left
                                sidebar</Link></li>
                              <li><Link onClick={ClickHandler} href="/blog-single-fullwidth/Top-5-Things-Hiriketiya-Beach">Blog details
                                fullwidth</Link></li>
                            </ul>
                          </li>
                        </ul>
                      ...
                      <li className="menu-item-has-children">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li><Link onClick={ClickHandler} href="/service/Free-Wifi">Service Single</Link></li>
