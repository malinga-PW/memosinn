                    ...
                    <div className="row">
                        <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="widget about-widget">
                                ...
                                <p>Your cozy haven in the heart of Hiriketiya. We're passionate about providing a relaxing and comfortable stay for every traveler.</p>
                                <ul>
                                    <li>
                        ...
                        <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="widget wpo-service-link-widget">
                                ...
                                <div className="contact-ft">
                                    <ul>
                                        <li><i className="fi flaticon-placeholder"></i>Dodampahala, Dikwella, Matara, Sri Lanka. 81200</li>
                                        <li><i className="fi flaticon-phone-call"></i>+94 777 391 870</li>
                                        <li><i className="fi flaticon-send"></i>info@memosinn.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col col-xs-12">
                            <p className="copyright"> Copyright &copy; 2026 Memos Inn. All Rights Reserved. Powered by <Link onClick={ClickHandler} href="https://cyber.pixelwave.lk">PixelWave Cyber</Link>.</p>
                        </div>
                    </div>
                </div>
            </div>
